...
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('hpoe01', 'hpoe@outlook.com', 'hansel', TO_DATE('2024-10-16', 'YYYY-MM-DD'), 1);
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('jpat02', 'jpat@outlook.com', 'jessica', TO_DATE('2024-10-15', 'YYYY-MM-DD'), 1);
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('jkim03', 'jkim@gmail.com', 'jeff', TO_DATE('2024-10-14', 'YYYY-MM-DD'), 1);
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('skat04', 'kat@gmail.com', 'kat', TO_DATE('2024-10-13', 'YYYY-MM-DD'), 1);
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('ljon05', 'jon@gmail.com', 'jon', TO_DATE('2024-10-12', 'YYYY-MM-DD'), 1);
INSERT INTO USERS (USERNAME, EMAIL, DISPLAYNAME, DATEJOINED, AGE) VALUES
    ('BillyBobJoe', 'bbj@gmail.com', 'IAmBBJ', TO_DATE('2012-01-02', 'YYYY-MM-DD'), 1);
