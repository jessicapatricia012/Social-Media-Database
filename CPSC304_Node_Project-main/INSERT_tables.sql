...
VALUES
    ('jpat02', 'jpat@outlook.com', TO_DATE('2024-10-15', 'YYYY-MM-DD'), 'jessica', 'hpoe01', 'jkim03');
INSERT INTO USERS (USERNAME, EMAIL, DATEJOINED, DISPLAYNAME,FOLLOWEDUSERNAME)
VALUES
    ('jkim03', 'jkim@gmail.com', TO_DATE('2024-10-14', 'YYYY-MM-DD'), 'jeff', 'hpoe01');
INSERT INTO USERS (USERNAME, EMAIL, DATEJOINED, DISPLAYNAME, FOLLOWINGUSERNAME)
VALUES
    ('skat04', 'kat@gmail.com', TO_DATE('2024-10-13', 'YYYY-MM-DD'), 'kat', 'jkim03');
INSERT INTO USERS (USERNAME, EMAIL, DATEJOINED, DISPLAYNAME)
VALUES
